...
!(function (t) {
  ...
  function O(t, e) {
    ...
    for (
      n = 0;
      n < Xt.length && ((i = Xt[n]), (r = V(i, t, e)), !(r >= 1 && ot(r)));
      n++
    );
    return i;
  }
  ...
  function ut(e, n) {
    return e && e.then && "resolved" !== e.state()
      ? n
        ? e.then(n)
        : void 0
      : t.when(n());
      ...
      e.isMoment(u) || j(u) || void 0 === u
        ...
        : ((s = !1),
          ...
          s
            ...
            : r && (o ? (a._ambigZone = !0) : d && a.utcOffset(u))),
      (a._fullCalendar = !0),
      a
    );
  }
  ...
  function gt(t, e) {
    ...
    return "string" == typeof e
      ...
      ? ie[n]
        ? ie[n](t)
        : ct(t, n)
      : e.maybe && ((i = ft(t, e.maybe)), i.match(/[1-9]/))
      ? i
      : "";
  }
  ...
  function vt(t, e, n, i, r) {
    var s,
      ...
      g = "",
      p = "";
    for (o = 0; o < n.length && ((s = mt(t, e, u, d, n[o])), s !== !1); o++)
      c += s;
    for (l = n.length - 1; l > o && ((s = mt(t, e, u, d, n[l])), s !== !1); l--)
      h = s + h;
  ...
  function mt(t, e, n, i, r) {
    ...
    return "string" == typeof r
      ? r
      : !!((s = r.token) && ((o = re[s.charAt(0)]), o && n.isSame(i, o))) &&
          ct(t, s);
  }
  function yt(t) {
  ...
  function Ot(n, i) {
    ...
    function o() {
      n.addClass("fc"),
        ...
        j.options.handleWindowResize &&
          ((J = at(m, j.options.windowResizeDelay)), t(window).resize(J));
    }
    function l() {
    ...
    function d(e, n) {
      lt++,
        ...
        !K &&
          e &&
          ((K = j.view = ot[e] || (ot[e] = j.instantiateView(e))),
          K.setElement(
            t("<div class='fc-view fc-" + e + "-view' />").appendTo($)
          ),
          q.activateButton(e)),
        K &&
          ((tt = K.massageCurrentDate(tt)),
          (K.displaying && tt >= K.intervalStart && tt < K.intervalEnd) ||
            (u() && (K.display(tt, n), O(), H(), T(), E()))),
        O(),
        lt--;
    }
    function c() {
    ...
    function T() {
      var t = j.getNow();
      t >= K.intervalStart && t < K.intervalEnd
        ? q.disableButton("today")
        : q.enableButton("today");
    }
    function x(t, e) {
    ...
    function Y(t) {
      ...
      if (1 === n) {
        ...
        if ("businessHours" === e)
          return void (
            K && (K.unrenderBusinessHours(), K.renderBusinessHours())
          );
    ...
    function W(t, e) {
      ...
      if (((e = e || st), this.triggerWith(t, e, n), j.options[t]))
    ...
    j.bindOptions(
      ...
      function (t, e, n, i, s, o, l) {
        ...
        ("ISO" !== l && "local" !== l && "function" != typeof l) ||
          (U._fullCalendar_weekCalc = l),
          tt && r(tt);
      }
    ),
      (j.defaultAllDayEventDuration = e.duration(
        j.options.defaultAllDayEventDuration
      )),
      (j.defaultTimedEventDuration = e.duration(
        j.options.defaultTimedEventDuration
      )),
      (j.moment = function () {
        var t;
        return (
          "local" === j.options.timezone
            ...
            : (t =
                "UTC" === j.options.timezone
                  ? jt.moment.utc.apply(null, arguments)
      ...
      (j.getDefaultEventEnd = function (t, e) {
        ...
        return (
          t
            ? n.stripTime().add(j.defaultAllDayEventDuration)
            : n.add(j.defaultTimedEventDuration),
    ...
    var q,
      ...
      ut = [];
    (tt =
      null != j.options.defaultDate
        ? j.moment(j.options.defaultDate).stripZone()
        : j.getNow()),
      ...
      (j.isHeightAuto = function () {
        return (
          "auto" === j.options.contentHeight || "auto" === j.options.height
        );
      }),
  ...
  function _t(e) {
    function n() {
      ...
      (f = n.theme ? "ui" : "fc"),
        s
          ? (h ? h.empty() : (h = this.el = t("<div class='fc-toolbar'/>")),
            h
              .append(r("left"))
              .append(r("right"))
              .append(r("center"))
                ...
                : ((s = (r.customButtons || {})[i])
                  ...
                  u &&
                    ...
                    (y = t(
                      ...
                      .click(function (t) {
                        y.hasClass(f + "-state-disabled") ||
                          (u(t),
                          (y.hasClass(f + "-state-active") ||
                            y.hasClass(f + "-state-disabled")) &&
                            y.removeClass(f + "-state-hover"));
                      })
                      .mousedown(function () {
                      ...
                      .hover(
                        ...
                        function () {
                          y.removeClass(f + "-state-hover").removeClass(
                            f + "-state-down"
                          );
                        }
                      )),
  ...
  function Yt() {
        ...
        if (n === e._fetchId && "rejected" !== e._status) {
          if (((e._status = "resolved"), i))
            for (r = 0; r < i.length; r++)
              (s = i[r]), (o = a ? s : R(s, e)), o && j.push.apply(j, L(o));
          l();
        }
      });
    }
    ...
    function a(e, n) {
      ...
      for (i = 0; i < s.length; i++) {
        if (
          ((r = s[i].call(F, e, O.clone(), V.clone(), F.options.timezone, n)),
          r === !0)
        )
          return;
    ...
    function C(t, e) {
      var n,
        ...
        s = R(t);
      if (s) {
        for (n = L(s), i = 0; i < n.length; i++)
          (r = n[i]),
            r.source || (e && (_.events.push(r), (r.source = _)), j.push(r));
        return P(j), n;
      }
      return [];
    }
    ...
    function R(n, i) {
      ...
      if (
        ...
        s && ((s = F.moment(s)), s.isValid() || (s = null)),
          (o = n.allDay),
          void 0 === o &&
            (o = J(i ? i.allDayDefault : void 0, F.options.allDayDefault)),
          I(r, s, o, l);
      }
    ...
    function k(t) {
      M(t),
        ...
        t.end ||
          (F.options.forceEventDuration
            ? (t.end = F.getDefaultEventEnd(t.allDay, t.start))
            : (t.end = null));
    }
    function M(t) {
      null == t.allDay &&
        ...
        t.allDay
          ...
          : (t.start.hasTime() || (t.start = F.applyTimezone(t.start.time(0))),
            t.end &&
              !t.end.hasTime() &&
              (t.end = F.applyTimezone(t.end.time(0))));
    }
    function L(e, n, i) {
      var r,
        s,
      ...
      return (
        ...
        (s = {
          start: e._start.clone(),
            ...
            ? e._end.clone()
            : F.getDefaultEventEnd(e._allDay, e._start),
          allDay: n.allDay,
        }),
        k(s),
        ...
        t.each(e, function (e, u) {
          ...
          (d = {
            ...
            n
              ...
              : s &&
                !c.end &&
                (c.end = F.getDefaultEventEnd(c.allDay, c.start)),
    ...
    var O,
      ...
      j = [];
    t.each(
      (F.options.events ? [F.options.events] : []).concat(
        F.options.eventSources || []
      ),
      function (t, e) {
        var n = d(e);
        n && Y.push(n);
    ...
    return (
      this.each(function (r, s) {
        ...
        "string" == typeof e
          ...
          : a || ((a = new Ee(l, e)), l.data("fullCalendar", a), a.render());
      }),
      i
    );
  };
  ...
  ne.push("_fullCalendar"),
    ...
    (te.week = te.weeks =
      function (t) {
        ...
        return null == t && "function" == typeof e
          ? e(this)
          : "ISO" === e
          ? ee.isoWeek.apply(this, arguments)
          : ee.week.apply(this, arguments);
      }),
    (te.time = function (t) {
    ...
    (te.local = function (t) {
      return (
        ee.local.call(this, this._ambigZone || t),
        (this._ambigTime = !1),
        (this._ambigZone = !1),
        this
      );
    ...
    (te.format = function () {
      return this._fullCalendar && arguments[0]
        ...
        : ee.format.apply(this, arguments);
    }),
    (te.toISOString = function () {
      return this._ambigTime
        ...
        : this._ambigZone
        ? ct(this, "YYYY-MM-DD[T]HH:mm:ss")
        : ee.toISOString.apply(this, arguments);
    });
  var ie = {
    t: function (t) {
    ...
    pe = (jt.Grid = wt.extend(ae, ue, {
      ...
      getDayClasses: function (t) {
        var e = this.view,
          ...
          i = ["fc-" + $t[t.day()]];
        return (
          1 == e.intervalDuration.as("months") &&
  ...
  pe.mixin({
    ...
    buildSegDragListener: function (t) {
      ...
      var c = (this.segDragListener = new fe(l, {
        ...
        dragStart: function (n) {
          c.isTouch && !l.isEventSelected(d) && l.selectEvent(d),
            (e = !0),
        ...
        hitOver: function (e, o, u) {
          ...
          t.hit && (u = t.hit),
            ...
            i &&
              !a.isEventSpanAllowed(r.eventToSpan(i), d) &&
              (s(), (i = null)),
            i && (h = l.renderDrag(i, t))
              ? (h.addClass("fc-dragging"),
                c.isTouch || r.applyDragOpacity(h),
                n.hide())
              : n.show(),
            o && (i = null);
        },
        ...
        interactionEnd: function (s) {
          delete t.component,
            n.stop(!i, function () {
              e && (l.unrenderDrag(), l.showEvent(d), r.segDragStop(t, s)),
                i && l.reportEventDrop(d, i, this.largeUnit, u, s);
            }),
        ...
        h = (this.segResizeListener = new fe(this, {
          ...
          hitOver: function (n, o, u) {
            var h = r.getHitSpan(u),
              f = r.getHitSpan(n);
            (i = e
              ? r.computeEventStartResize(h, f, d)
              : r.computeEventEndResize(h, f, d)),
              i &&
                (a.isEventSpanAllowed(r.eventToSpan(i), d)
                  ? i.start.isSame(d.start.clone().stripZone()) &&
          ...
          interactionEnd: function (e) {
            n && r.segResizeStop(t, e),
              i && l.reportEventResize(d, i, this.largeUnit, u, e),
    ...
    invertRanges: function (t) {
      var e,
        ...
        o = [],
        l = r;
      for (t.sort(kt), e = 0; e < t.length; e++)
        (n = t[e]),
    ...
    compareEventSegs: function (t, e) {
      return (
        ...
        L(t.event, e.event, this.view.eventOrderSpecs)
      );
    },
  }),
  ...
  me.mixin({
    ...
    getEventSegs: function () {
      return pe.prototype.getEventSegs
        .call(this)
    ...
    fgSegHtml: function (t, e) {
      ...
      return (
        ...
        t.isStart &&
          ...
          n && (c = '<span class="fc-time">' + tt(n) + "</span>")),
        (i =
          '<span class="fc-title">' +
          (tt(s.title || "") || "&nbsp;") +
          "</span>"),
    ...
    me.mixin({
      ...
      limitRow: function (e, n) {
        function i(i) {
          for (; D < i; )
            (u = S.getCellSegs(e, D, n)),
              u.length &&
                ((h = s[n - 1][D]),
                (y = S.renderMoreLink(e, D, u)),
                (m = t("<div/>").append(y)),
                h.append(m),
                E.push(m[0])),
              D++;
        ...
        if (n && n < w.segLevels.length) {
          for (
            ...
            for (a = r[l], i(a.leftCol), c = [], d = 0; D <= a.rightCol; )
              (u = this.getCellSegs(e, D, n)), c.push(u), (d += u.length), D++;
            if (d) {
              for (
                h = s[n - 1][a.leftCol],
                  f = h.attr("rowspan") || 1,
          ...
          .on("click", function (o) {
            ...
            "function" == typeof l &&
              (l = s.trigger(
                "eventLimitClick",
                null,
                { date: a, dayEl: d, moreEl: u, segs: h, hiddenSegs: f },
                o
              )),
              "popover" === l
          ...
          !!i.class &&
            (s &&
              ...
              s.valueOf() &&
                ((i.duration = s),
                (o = O(s)),
                1 === s.as(o) && ((i.singleUnit = o), d.unshift(l[o] || {})))),
            (i.defaults = n(u)),
            (i.overrides = n(d)),
  ...
  jt.locale("en", Ee.englishDefaults),
  ...
  var Ie = (jt.BasicView = Se.extend({
      ...
      setRange: function (t) {
        Se.prototype.setRange.call(this, t),
  ...
  var Ge = Se.extend({
    ...
    Ae = pe.extend({
      ...
      handleSegClick: function (e, n) {
        var i;
        pe.prototype.handleSegClick.apply(this, arguments),
